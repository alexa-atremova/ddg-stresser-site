    ...
    <MainContainer>
      <Wrapper>
        <TopSection>
          <LeftSection>
            <Title>
              DDG-STRESSER - это сервис, через который можно проводить маштабную
              тестировку ваших ресурсов.
            </Title>
            <Text>
              С использованием нашей мощной DDoS-сети с передовыми методами и
              высокой мощностью. Мы предлагаем наиболее эффективные методы,
              которые могут обойти несколько защит ресурса.
            </Text>
            <div className="btn">
